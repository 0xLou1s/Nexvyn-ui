...
export function Header() {
  return (
    <header 
      className="max-w-6xl mx-auto w-full px-4 sm:px-6 md:px-12 py-4 md:py-12 flex items-center justify-between text-sm tracking-tight bg-transparent relative z-10"
    ...
    >
      ...
      <div className="hidden md:flex flex-1 justify-center">
        <span className="font-medium" style={{ color: 'var(--color-fg)' }}>Welcome</span>
      </div>
      <div className="flex-1 flex justify-end items-center gap-2">
        <a
          ...
          aria-label="GitHub"
          className="inline-flex items-center gap-1.5 h-9 px-3 rounded-md text-sm font-medium transition-colors text-(--color-fg) hover:bg-(--color-surface) outline-none focus-visible:ring-2 focus-visible:ring-(--color-accent)"
        >
